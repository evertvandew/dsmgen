...
def dataClassEditorForm(o, objecttype, data_store: DataStore, default=None, update=None):
...
def dataClassEditor(objecttype, data_store: DataStore, defaults=None, update=None):
    ...
    form = dataClassEditorForm(o, objecttype, data_store, default=defaults, update=update)
    # Add a SAVE button
    def onSave(_):
