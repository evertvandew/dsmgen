...
class ResizeStates(BehaviourFSM):
    ...
    def __init__(self, diagram):
        super().__init__()
        self.state: ResizeStates.States = self.States.NONE
...
class BlockCreateWidget:
    ...
    def onMouseDown(self, ev, index, block):
        ...
        instance = block(name='', x=300, y=300, height=self.height, width=int(1.6*self.height), parent=self.diagram_id)
