...
class Diagram(OwnerInterface):
    ...
    def __init__(self, widgets, api: DataStore=None, diagram_id=None, repr_lu={}, allowed_connections={}):
        self.selection = None
    ...
    def onDrop(self, ev):
        ...
        repr_cls = self.repr_lu[block_cls.__name__]
...
class BlockCreateWidget:
    ...
    def __init__(self, diagram):
        ...
        for i, (name, block_cls) in enumerate(blocks.items()):
            repr_cls = diagram.repr_lu[block_cls.__name__]
            ...
            shape.bind('mousedown', bindFunc(i, repr_cls))
        diagram.canvas <= g
    ...
    def onMouseDown(self, ev, index, block):
        ...
        instance = block(x=300, y=300, height=self.height, width=int(1.6*self.height), diagram=self.diagram_id)
