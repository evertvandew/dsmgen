...
class Diagram(OwnerInterface):
    ...
    def __init__(self, widgets, api: DiagramDataApi=None, diagram_id=None, repr_lu={}):
        self.selection = None
    ...
    def onDrop(self, ev):
        ...
        kwargs = {f.name: drop_details.get(f.name) for f in fields(block_cls)}
