...
class Diagram(OwnerInterface):
    ...
    def __init__(self, widgets, api: DiagramDataApi=None, diagram_id=None):
        self.selection = None
...
def load_diagram(diagram_id, diagram_cls, api, canvas):
    diagram = diagram_cls([BlockCreateWidget], api, diagram_id)
    diagrams.append(diagram)
    diagram.bind(canvas)
