...
class Stylable:
    ...
    def loadStyle(self, s):
        ...
        self.styling = MappingProxyType(details)
...
class Shape(Stylable):
    ...
    z: float = 0.0
    shape_type: str = 'Rect'
    styling: MappingProxyType[str, str] = field(default_factory=lambda: MappingProxyType({}))
    ...
    def updateStyle(self, **updates):
        d = dict(self.styling)
        d.update(updates)
        self.styling = MappingProxyType(d)
...
class Relationship(Stylable):
    ...
    default_style = dict(linecolor='#000000', linewidth='2', endmarker='arrow', startmarker='arrow', routing_method='square')
...
class Container(Shape, OwnerInterface):
    ...
    shape_descriptor = BasicShape.getDescriptor('Rect')
